...
with st.sidebar:
    opciones = option_menu("Clickea aquí: ",['Inicio', "¿Qué tipo de idol eres?",'¿Que tanto sabes de los IDOLS?'] , #Seleccionamos las opciones para interactuar 
